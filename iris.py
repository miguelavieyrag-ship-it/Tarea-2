...
def user_input_features():
  ...
  sepal_length_cm = st.number_input('Longitud del Zepalo:', min_value=0.0, max_value=8.0, value = 0.5, step = 0.1)
  sepal_width_cm = st.number_input('Ancho del Zepalo:', min_value=0.0, max_value=5.0, value = 0.5, step = 0.1)
  petal_length_cm = st.number_input('Longitud del petalo:', min_value=0.0, max_value=7.0, value = 0.5, step = 0.1)
  petal_width_cm = st.number_input('Ancho del petalo:',min_value=0.0, max_value=3.0, value = 0.5, step = 0.1)
...
X = titanic.drop(columns='species')
Y = titanic['species']
